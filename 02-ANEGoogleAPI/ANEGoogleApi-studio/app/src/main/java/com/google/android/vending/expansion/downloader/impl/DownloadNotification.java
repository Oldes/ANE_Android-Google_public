...
class DownloadNotification {
    ...
    void onDownloadStateChanged(int newState) {
        ...
        if (newState != mState) {
            ...
            Log.d("Amanita", "onDownloadStateChanged: " + newState + " stringDownloadID:" + stringDownloadID + " iconResource:" + iconResource);
    ...
    void onDownloadProgress(DownloadProgressInfo progress) {
        ...
        if (progress.mOverallTotal <= 0) {
            ...
            mActiveDownloadBuilder.setContentInfo(mContext.getString(GoogleExtension.getResourceStringID("time_remaining_notification"),
