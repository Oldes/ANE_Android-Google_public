...
public class Helpers {
    ...
    public static long getAvailableBytes(File root) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN_MR2) {
            ...
            @SuppressWarnings( "deprecation" )
            long availableBytes = availableBlocks * stat.getBlockSize();
    ...
    static public int getDownloaderStringResourceIDFromState(int state) {
        switch (state) {
            case IDownloaderClient.STATE_IDLE:
                return GoogleExtension.getResourceStringID("state_idle");
            case IDownloaderClient.STATE_FETCHING_URL:
                return GoogleExtension.getResourceStringID("state_fetching_url");
            case IDownloaderClient.STATE_CONNECTING:
                return GoogleExtension.getResourceStringID("state_connecting");
            case IDownloaderClient.STATE_DOWNLOADING:
                return GoogleExtension.getResourceStringID("state_downloading");
            case IDownloaderClient.STATE_COMPLETED:
                return GoogleExtension.getResourceStringID("state_completed");
            case IDownloaderClient.STATE_PAUSED_NETWORK_UNAVAILABLE:
                return GoogleExtension.getResourceStringID("state_paused_network_unavailable");
            case IDownloaderClient.STATE_PAUSED_BY_REQUEST:
                return GoogleExtension.getResourceStringID("state_paused_by_request");
            case IDownloaderClient.STATE_PAUSED_WIFI_DISABLED_NEED_CELLULAR_PERMISSION:
                return GoogleExtension.getResourceStringID("state_paused_wifi_disabled");
            case IDownloaderClient.STATE_PAUSED_NEED_CELLULAR_PERMISSION:
                return GoogleExtension.getResourceStringID("state_paused_wifi_unavailable");
            case IDownloaderClient.STATE_PAUSED_WIFI_DISABLED:
                return GoogleExtension.getResourceStringID("state_paused_wifi_disabled");
            case IDownloaderClient.STATE_PAUSED_NEED_WIFI:
                return GoogleExtension.getResourceStringID("state_paused_wifi_unavailable");
            case IDownloaderClient.STATE_PAUSED_ROAMING:
                return GoogleExtension.getResourceStringID("state_paused_roaming");
            case IDownloaderClient.STATE_PAUSED_NETWORK_SETUP_FAILURE:
                return GoogleExtension.getResourceStringID("state_paused_network_setup_failure");
            case IDownloaderClient.STATE_PAUSED_SDCARD_UNAVAILABLE:
                return GoogleExtension.getResourceStringID("state_paused_sdcard_unavailable");
            case IDownloaderClient.STATE_FAILED_UNLICENSED:
                return GoogleExtension.getResourceStringID("state_failed_unlicensed");
            case IDownloaderClient.STATE_FAILED_FETCHING_URL:
                return GoogleExtension.getResourceStringID("state_failed_fetching_url");
            case IDownloaderClient.STATE_FAILED_SDCARD_FULL:
                return GoogleExtension.getResourceStringID("state_failed_sdcard_full");
            case IDownloaderClient.STATE_FAILED_CANCELED:
                return GoogleExtension.getResourceStringID("state_failed_cancelled");
            default:
                return GoogleExtension.getResourceStringID("state_unknown");
        }
    }
